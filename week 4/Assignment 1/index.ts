...
abstract class Game {
  constructor(public title: string, public price: numandstring, public company?:string) {}
...
class Action extends Game {
    constructor(title: string, public price: numandstring, public rate: number,company:string) {
        super(title, price,company);
    }
    getLocation(): string {
        return `Location`
    }
